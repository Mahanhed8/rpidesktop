controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    game.splash(game.ask("Are You Sure To turn Off"))
    music.play(music.stringPlayable("C5 A E B D C5 F C ", 370), music.PlaybackMode.UntilDone)
...
controller.A.onEvent(ControllerButtonEvent.Pressed, function () {
    ...
    game.splash("UI.ini v3.0.0", "Powered by VShow")
    music.play(music.createSong(assets.song`rabandodon`), music.PlaybackMode.UntilDone)
...
game.splash("Welcome To The Raspberry Pi Desktop", "rpiboot.ini.img")
